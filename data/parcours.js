...
/* ---- Construction automatique des examens : 2 questions de chaque leçon du bloc ---- */
(function(){
  window.PARCOURS.forEach(function(b){
    var qs = [];
    b.lecons.forEach(function(l){
      var picks = [1, l.questions.length - 1];       // 2ᵉ et dernière question de chaque leçon
      if(picks[0] === picks[1]) picks = [0];
      picks.forEach(function(i){ qs.push(Object.assign({}, l.questions[i])); });
    });
